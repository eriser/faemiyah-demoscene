...
} g_symbol_table =
{
  ...
  (void (GLAPIENTRY *)(GLenum))0xb5f7c43L,
  ...
  (void (GLAPIENTRY *)(GLbitfield))0x1fd92088L,
  (void (*)(int))0x29f14a4L,
  (void (GLAPIENTRY *)(GLint, GLsizei, const GLfloat*))0x21b64a33L,
  (void (*)(void))0x7eb657f3L,
  (void (GLAPIENTRY *)(GLuint))0xe9e99723L,
  (GLint (GLAPIENTRY *)(GLuint, const GLchar*))0xceb27dd0L,
